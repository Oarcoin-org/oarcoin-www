...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "flex h-10 items-center gap-0.5 border border-foreground p-1 bg-white divide-x divide-foreground",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center h-full rounded-sm px-3 py-[2px] gap-1 text-sm font-medium outline-hidden select-none hover:bg-foreground/5 aria-expanded:bg-muted",
        className
      )}
      {...props}
    />
